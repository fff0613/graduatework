...
public class SysUserServiceImpl extends ServiceImpl<SysUserDao, SysUserEntity> implements SysUserService {
	...
	@Override
	public List<Long> getIdByUserName(String username) {
	...
	List<SysUserEntity> queryRepairList(Integer deviceid){
	...
	public AppUserEntity queryByMobile(String mobile) {
		...
		AppUserEntity appUserEntity = baseMapper.queryByMobile(mobile);
